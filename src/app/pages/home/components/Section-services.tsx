    ...
    return (<>
        ...
        <section className={style.section_services} id='section-services'>
            <div className={style.container_section_services}>
                ...
                <p className="mb-6  inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                ...
                <ol className="relative border-s border-gray-200 dark:border-gray-700">
                    <li className="mb-10 ms-4">
                        ...
                        <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Primeiro passo</time>
